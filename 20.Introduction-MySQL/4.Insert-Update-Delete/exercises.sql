...
DELETE FROM BoxOffice WHERE movie_id = 2;
DELETE FROM BoxOffice WHERE movie_id = 9;
DELETE FROM Movies WHERE director = 'Andrew Staton';

UPDATE BoxOffice SET rating = 9 WHERE domestic_sales > 400000000;

UPDATE BoxOffice SET rating = 6 WHERE domestic_sales > 200000000 AND international_sales < 300000000;
